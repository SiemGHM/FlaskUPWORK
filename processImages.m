...
function result = processImages(imageDir, processedDir)
    ...
    for g = 1:length(arcFiles)
        ...
        processedFileName = sprintf('%s_processed.jpeg', timestamp);
        processedImagePath = fullfile(processedDir, processedFileName);
